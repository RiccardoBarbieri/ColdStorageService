...
public class JTestSprint1v0 {
	...
	private String sendTicketRequest(String ticketNumber){
		return sendMessage("deposit", ticketNumber);
	}
	...
	private void implementProtocol(Float fw) {
		...
		if (fw <= MAXW) {
		    ...
		    String ticket = "1224"; // recuperare il ticket dalla risposta
		    
			answer = sendTicketRequest(ticket);
