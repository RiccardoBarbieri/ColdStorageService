			...
			var isMoving = false
				...
				state("engage") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t026",targetState="engageFail",cond=whenTimeout("local_tout_trolleyexecutor_engage"))   
					transition(edgeName="t027",targetState="setState",cond=whenReply("engagedone"))
					transition(edgeName="t028",targetState="engageFail",cond=whenReply("engagerefused"))
				}	 
				...
				state("waiting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t029",targetState="move",cond=whenRequest("move"))
					transition(edgeName="t030",targetState="stop",cond=whenRequestGuarded("moveclosest",{ isMoving  
					}))
					transition(edgeName="t031",targetState="askPosition",cond=whenRequestGuarded("moveclosest",{ !isMoving  
					}))
				}	 
				state("move") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t032",targetState="timeout",cond=whenTimeout("local_tout_trolleyexecutor_move"))   
					transition(edgeName="t033",targetState="stop",cond=whenRequest("moveclosest"))
					transition(edgeName="t034",targetState="moveCompleted",cond=whenReply("moverobotdone"))
					transition(edgeName="t035",targetState="moveFail",cond=whenReply("moverobotfailed"))
				}	 
				state("stop") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t036",targetState="askPosition",cond=whenTimeout("local_tout_trolleyexecutor_stop"))   
					transition(edgeName="t037",targetState="askPosition",cond=whenReply("moverobotfailed"))
				}	 
				state("askPosition") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t038",targetState="timeout",cond=whenTimeout("local_tout_trolleyexecutor_askPosition"))   
					transition(edgeName="t039",targetState="moveClosest",cond=whenReply("robotstate"))
				}	 
				state("moveClosest") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t040",targetState="timeout",cond=whenTimeout("local_tout_trolleyexecutor_moveClosest"))   
					transition(edgeName="t041",targetState="movecCompleted",cond=whenReply("moverobotdone"))
					transition(edgeName="t042",targetState="movecFail",cond=whenReply("moverobotfailed"))
				}	 
