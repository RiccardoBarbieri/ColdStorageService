			...
			var isMoving = false
				...
				state("engage") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t024",targetState="engageFail",cond=whenTimeout("local_tout_trolleyexecutor_engage"))   
					transition(edgeName="t025",targetState="setState",cond=whenReply("engagedone"))
					transition(edgeName="t026",targetState="engageFail",cond=whenReply("engagerefused"))
				}	 
				...
				state("waiting") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t027",targetState="move",cond=whenRequest("move"))
					transition(edgeName="t028",targetState="stop",cond=whenRequestGuarded("moveclosest",{ isMoving  
					}))
					transition(edgeName="t029",targetState="askPosition",cond=whenRequestGuarded("moveclosest",{ !isMoving  
					}))
				}	 
				state("move") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t030",targetState="timeout",cond=whenTimeout("local_tout_trolleyexecutor_move"))   
					transition(edgeName="t031",targetState="stop",cond=whenRequest("moveclosest"))
					transition(edgeName="t032",targetState="moveCompleted",cond=whenReply("moverobotdone"))
					transition(edgeName="t033",targetState="moveFail",cond=whenReply("moverobotfailed"))
				}	 
				state("stop") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t034",targetState="askPosition",cond=whenTimeout("local_tout_trolleyexecutor_stop"))   
					transition(edgeName="t035",targetState="askPosition",cond=whenReply("moverobotfailed"))
				}	 
				state("askPosition") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t036",targetState="timeout",cond=whenTimeout("local_tout_trolleyexecutor_askPosition"))   
					transition(edgeName="t037",targetState="moveClosest",cond=whenReply("robotstate"))
				}	 
				state("moveClosest") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t038",targetState="timeout",cond=whenTimeout("local_tout_trolleyexecutor_moveClosest"))   
					transition(edgeName="t039",targetState="movecCompleted",cond=whenReply("moverobotdone"))
					transition(edgeName="t040",targetState="movecFail",cond=whenReply("moverobotfailed"))
				}	 
