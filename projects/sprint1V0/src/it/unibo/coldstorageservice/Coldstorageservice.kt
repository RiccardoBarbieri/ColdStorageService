...
class Coldstorageservice ( name: String, scope: CoroutineScope, isconfined: Boolean=false  ) : ActorBasicFsm( name, scope, confined=isconfined ){
	...
	override fun getBody() : (ActorBasicFsm.() -> Unit){
		val interruptedStateTransitions = mutableListOf<Transition>()
				...
				state("s0") { //this:State
					action { //it:State
						request("toindoor", "deposit(arg)" ,"transporttrolley" )  
						request("depositcharge", "depositcharge(arg)" ,"transporttrolley" )  
						request("returnhome", "returnhome(arg)" ,"transporttrolley" )  
