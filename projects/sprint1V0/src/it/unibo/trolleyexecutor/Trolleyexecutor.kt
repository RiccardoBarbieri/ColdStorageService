			...
			var isMoving = false
				...
				state("engage") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t020",targetState="engageFail",cond=whenTimeout("local_tout_trolleyexecutor_engage"))   
					transition(edgeName="t021",targetState="setState",cond=whenReply("engagedone"))
					transition(edgeName="t022",targetState="engageFail",cond=whenReply("engagerefused"))
				}	 
				...
				state("stop") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t030",targetState="askPosition",cond=whenTimeout("local_tout_trolleyexecutor_stop"))   
					transition(edgeName="t031",targetState="askPosition",cond=whenReply("moverobotfailed"))
				}	 
				state("askPosition") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t032",targetState="timeout",cond=whenTimeout("local_tout_trolleyexecutor_askPosition"))   
					transition(edgeName="t033",targetState="moveClosest",cond=whenReply("robotstate"))
				}	 
				state("moveClosest") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t034",targetState="timeout",cond=whenTimeout("local_tout_trolleyexecutor_moveClosest"))   
					transition(edgeName="t035",targetState="movecCompleted",cond=whenReply("moverobotdone"))
					transition(edgeName="t036",targetState="movecFail",cond=whenReply("moverobotfailed"))
				}	 
