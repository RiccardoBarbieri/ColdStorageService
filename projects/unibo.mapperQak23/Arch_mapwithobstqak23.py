...
with Diagram('mapwithobstqak23Arch', show=False, outformat='png', graph_attr=graphattr) as diag:
  with Cluster('env'):
     ...
     mapwithobstqak23 >> Edge(color='magenta', style='solid', xlabel='doplan', fontcolor='magenta') >> basicrobot
     ...
     mapusage >> Edge(color='magenta', style='solid', xlabel='doplan', fontcolor='magenta') >> basicrobot
     ...
     mover >> Edge(color='magenta', style='solid', xlabel='doplan', fontcolor='magenta') >> basicrobot
