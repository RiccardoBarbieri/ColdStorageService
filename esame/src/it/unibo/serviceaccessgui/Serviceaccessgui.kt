		...
		return { //this:ActionBasciFsm
				...
				state("work") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t04",targetState="handleStorereply",cond=whenReply("storereply"))
					transition(edgeName="t05",targetState="handleTicketreply",cond=whenReply("ticketreply"))
					transition(edgeName="t06",targetState="handleChargetaken",cond=whenDispatch("chargetaken"))
				}	 
				state("handleStorereply") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition( edgeName="goto",targetState="work", cond=doswitchGuarded({ IsRequestRejected  
					}) )
				...
				state("handleChargetaken") { //this:State
					action { //it:State
						if( checkMsgContent( Term.createTerm("chargetaken(TICKET)"), Term.createTerm("chargetaken(TICKET)"), 
						                        currentMsg.msgContent()) ) { //set msgArgList
								CommUtils.outblack("SAG | Ticket $payloadArg(1) can move away from INDOOR")
								delay(500) 
						}
						//genTimer( actor, state )
					}
